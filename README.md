...
```powershell
.\scripts\package-release.ps1 -Version 0.13.1 -IncludeFFmpeg
```

Pakete prüfen:

```powershell
.\scripts\verify-release-package.ps1 -Version 0.13.1 -RequireFFmpegPackage
```
...
```powershell
Get-FileHash .\AudioQualityEnhancer-0.13.1-win-x64.zip -Algorithm SHA256
```
